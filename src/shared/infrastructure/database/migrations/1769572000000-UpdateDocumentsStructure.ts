...
export class UpdateDocumentsStructure1769572000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // 3. Si quedan documentos que no se les haya podido asignar un document_model_id, los eliminamos
    await queryRunner.manager.delete('documents', { document_model_id: null });

    // 4. Hacer que document_model_id no sea nullable
    ...
    // 5. Añade la foreign key a la columna document_model_id
    ...
    // 6. Eliminar las columnas antiguas
